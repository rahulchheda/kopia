...
func (store *kopiaMetadata) ConnectS3WithDeployedServer(bucketName, pathPrefix, addr string) error {
	return store.snap.ConnectS3WithDeployedServer(bucketName, pathPrefix, addr)
}
